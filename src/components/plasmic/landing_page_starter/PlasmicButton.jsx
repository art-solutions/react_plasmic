...
import sty from "./PlasmicButton.module.css"; // plasmic-import: UcW2nQ3YUMuW/css
    ...
    >
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__zRwei)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__g9PtT)}
                role={"img"}
              />
            ),
