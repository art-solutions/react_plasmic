...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: y3CQQkXE-Ct1/css
import SearchIcon from "./icons/PlasmicIcon__Search"; // plasmic-import: yHSKq2SzajQ5/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchIcon
              className={classNames(projectcss.all, sty.svg__iwExp)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckIcon
              className={classNames(projectcss.all, sty.svg__dCpMc)}
              role={"img"}
            />
          ),
